    ...
    return (
        ...
        >
            <a href="#" className="block whitespace-nowrap overflow-hidden">
                <FontAwesomeIcon icon={props.caret} className={`ml-[11px] w-[6px] ${isExpanded ? "rotate-90" : ""}`} />
                <FontAwesomeIcon icon={props.icon} className={`mr-7 w-5 ${props.caret ? "ml-[11px]" : "ml-7"}`} />
                <img
                    src={props.pfp}
